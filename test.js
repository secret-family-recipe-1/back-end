    ...
    it("should return the right object", async () => {
      ...
      expect(res.body).toEqual(`
            <title><h1>rVenture</h1></title>
              ...
              <h2>https://rventure.herokuapp.com/      :heavy_check_mark:   api status</h2>
              <h3>https://rventure.herokuapp.com/api/  :trolleybus:  endpoint documentation</h3>
              <hr>
              <h3>https://rventure.herokuapp.com/auth/ :closed_lock_with_key:  endpoint documentation</h3>
              `);
    });
  });
});
    ...
    describe('server.js', () => {
      ...
      describe('login', () => {
        ...
        it('should return DATA from the login route', async () => {
          ...
          const response = await request(server).post('/auth/login/landowner', {
            username: 'bigJohn',
            password: 'password'
          })
